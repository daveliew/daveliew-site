...
const sources = [
  {
    label: "Cisco: Personal AI Agents Like OpenClaw Are a Security Nightmare",
  ...
  {
    label: "OpenClaw Security Documentation",
    url: "https://docs.openclaw.ai/gateway/security",
  },
  {
    label: "Cisco Skill Scanner (Open Source)",
...
export default function OpenClawRiskContent() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <motion.section {...sectionAnimation(0)} className="mb-12">
        <h2 className="text-2xl font-semibold mb-4">What Is OpenClaw?</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-4">
          OpenClaw is an open-source personal AI agent created by Peter
          Steinberger, an Austrian developer. Originally launched as
          &quot;Clawd&quot; in November 2025, it was renamed to Moltbot on
          January 27, 2026, then to OpenClaw on January 30. It runs locally on
          your machine and connects to messaging platforms like WhatsApp,
          Telegram, Discord, Slack, and Microsoft Teams. With 140K+ GitHub stars
          and 2 million visitors in its first week, it&apos;s one of the
          fastest-growing agent projects in the wild.
        </p>
        <p className="text-gray-600 dark:text-gray-400 mb-4">
          It makes building conversational AI agents remarkably easy.
          That&apos;s both the appeal and the problem.
        </p>
        <p className="text-gray-600 dark:text-gray-400 text-sm italic">
          In February 2026, Steinberger announced he was joining OpenAI, and the
          project is moving to an open-source foundation.
        </p>
      </motion.section>
      ...
      <motion.section {...sectionAnimation(1)} className="mb-12">
        ...
        <Card className="p-6 bg-gradient-to-r from-red-500/5 to-red-500/10 border-l-4 border-red-500">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Security in OpenClaw is opt-in, not built-in. The default
            configuration prioritises developer convenience over safety.
            That&apos;s a reasonable choice for a local experiment&mdash;but
            these agents don&apos;t stay local.
          </p>
        </Card>
        <TechnicalDetail>
          <p>
            The default setup binds an unauthenticated HTTP endpoint, stores
            credentials in plaintext config files, and provides no network
            segmentation between skills. Security researchers have documented
            600+ publicly-exposed instances running default configurations. The
            gap between &quot;it works on my laptop&quot; and &quot;it&apos;s in
            production&quot; is one deployment command.
          </p>
        </TechnicalDetail>
      </motion.section>
      ...
      <motion.section {...sectionAnimation(2)} className="mb-12">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">
              &mdash; Exploitable with minimal effort
            </span>
          </div>
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">
              &mdash; Requires context-specific exploitation
            </span>
          </div>
          <div className="space-y-4">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-400">
              &mdash; Organisational and process risks
            </span>
          </div>
          <div className="space-y-4">
      ...
      <motion.section {...sectionAnimation(3)} className="mb-12">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-4">
          ...
          community-contributed plugins that execute locally as file
          packages&mdash;not remote like MCP servers. They run with full system
          access. Unlike browser extensions, there&apos;s no sandboxed
          permissions model, no review gate, and no revocation mechanism.
        </p>
        <Card className="p-4 border-l-4 border-amber-500">
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">
            Cisco&apos;s open-source Skill Scanner tool analysed 31,000 agent
            skills and found 26% contained at least one vulnerability. A
            malicious skill called &quot;What Would Elon Do?&quot; ranked #1 in
            the marketplace while containing data exfiltration and prompt
            injection payloads.
          </p>
        </Card>
        <TechnicalDetail>
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>
              <strong>Data exfiltration</strong>: Skills can make arbitrary HTTP
              requests (e.g., curl to external servers with conversation data).
            </li>
            <li>
              <strong>Prompt injection</strong>: Malicious skills can inject
              system prompts that override the agent&apos;s instructions.
            </li>
            <li>
              <strong>Tool poisoning</strong>: A compromised skill can return
              manipulated data to the LLM, causing downstream tool calls to
              execute unintended operations.
            </li>
            <li>
              <strong>Dependency confusion</strong>: npm-based skill
              installation is vulnerable to package substitution attacks.
            </li>
          </ul>
        </TechnicalDetail>
      </motion.section>
      ...
      <motion.section {...sectionAnimation(5)} className="mb-12">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          If your team wants to evaluate OpenClaw, here&apos;s a phased approach
          that manages risk.
        </p>
        ...
        <Card className="p-6 mb-4">
          ...
          <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
            <li>
              Run in a dedicated VM or container with no access to production
              networks
            </li>
            <li>Use test API keys with spending limits and rotation</li>
            <li>
              Connect only to sandboxed messaging channels (not production
              Slack/Teams)
            </li>
          ...
          <TechnicalDetail>
            <ul className="list-disc list-inside space-y-1">
              <li>
                Deploy via Docker Compose with network isolation (internal-only
                network)
              </li>
        ...
        <Card className="p-6 mb-4">
          ...
          <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
            <li>
              Connect to limited production channels with human-in-the-loop
              approval for actions
            </li>
            <li>Only allow vetted, internally-reviewed skills</li>
            <li>
              Implement transaction limits and confirmation flows for any
          ...
          <TechnicalDetail>
            <ul className="list-disc list-inside space-y-1">
              <li>
                Integrate with corporate secrets manager (Vault/AWS Secrets
                Manager)
              </li>
              <li>
        ...
        <Card className="p-6 bg-red-500/5 border-l-4 border-red-500">
          ...
          <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
            <li>
              &bull; Cannot enforce network isolation between the agent and
              production systems
            </li>
            <li>
              &bull; Security features cannot be enabled (version
              incompatibility, config conflicts)
            </li>
            <li>
              &bull; No dedicated security review capacity for skill vetting
            </li>
            <li>
              &bull; Regulatory requirements prohibit AI agent access to the
              data in scope (HIPAA, PCI-DSS, SOX)
            </li>
            <li>
              &bull; No incident response plan exists for autonomous agent
              misbehaviour
            </li>
          </ul>
        </Card>
      ...
      <motion.section {...sectionAnimation(6)} className="mb-12">
        <Card className="p-6 bg-gradient-to-r from-[var(--deep-purple)]/10 to-[var(--teal)]/10 border-l-4 border-[var(--deep-purple)]">
          ...
          <p className="text-2xl font-bold text-[var(--deep-purple)] mb-4">
            Pilot-safe with strict controls. Not enterprise-ready out of the
            box.
          </p>
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            OpenClaw is a capable framework with genuine utility. But its
            default-open security posture means the gap between demo and
            disaster is dangerously small. Any serious deployment requires
            deliberate hardening that goes well beyond the quick-start guide.
          </p>
        </Card>
      </motion.section>
      ...
      <motion.section {...sectionAnimation(8)} className="text-center">
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          This assessment applies the trust engineering framework to real-world
          agent evaluation.
        </p>
